import { AccountCentralizedInfo, AccountInfoResult, DeployContractPackageResult, DeployResult, TransactorHashType } from './types';
 ...
 */
export declare enum FTActionTypeEnum {
    'Mint' = 1,
    'Transfer' = 2,
    'Approve' = 3,
    'Burn' = 4
 ...
 */
export declare const FTActionType: {
    1: string;
    2: string;
    3: string;
    4: string;
};
export declare enum FTEntryPointType {
    approve = "approve",
    mint = "mint",
    burn = "burn",
    transfer = "transfer"
...
export declare function FTToken(obj: any): FTResult;
//# sourceMappingURL=FTToken.d.ts.map