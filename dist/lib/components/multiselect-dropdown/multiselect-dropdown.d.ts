...
export declare function MultiselectDropdown(props: MultiSelectInputProps): import("react/jsx-runtime").JSX.Element;
export default MultiselectDropdown;
//# sourceMappingURL=multiselect-dropdown.d.ts.map