...
import Downshift, {ControllerStateAndHelpers, useMultipleSelection, useSelect} from 'downshift';
...
const ItemContainer = styled(FlexRow)<FlexRowProps & {isHighlighted?: boolean}>(({ theme, isHighlighted }) => ({
  cursor: 'pointer',
  minHeight: 36,
  padding: '8px 16px',
  ':hover, :active': {
