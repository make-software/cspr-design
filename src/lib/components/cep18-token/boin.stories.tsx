...
} as ComponentMeta<typeof CEP18Token>;

const Template: ComponentStory<typeof CEP18Token> = (args) => (
  <FlexRow itemsSpacing={30}>
    <FlexColumn itemsSpacing={20}>
      ...
      <FlexColumn itemsSpacing={20}>
          ...
          <CEP18Token motes="1000123456789" decimals={9} precision={5} ticker={'BOIN'} />
      </FlexColumn>
    <FlexColumn itemsSpacing={20}>
    ...
    <FlexColumn itemsSpacing={20}>
      ...
      <CEP18Token motes="1000987" decimals={3} precision={3} ticker={'CLICK3'} />
    </FlexColumn>
    <FlexColumn itemsSpacing={20}>
