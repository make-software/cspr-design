...
import {
    ...
    auctionDeploy, cep18Deploy,
    csprFunDeploy, csprMarketDeploy,
    defaultDeploy,
    mockedAccountInfos,
    mockedContractInfos,
    mockedContractPackageInfos, nftDeploy, transferDeploy
...
const exampleComponents = [
    ...
    },
    {
        ...
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(transferDeploy)} />
    },{
        templateLabel: 'Cspr.fun action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(csprFunDeploy)} />
    },
    {
        templateLabel: 'Auction action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(auctionDeploy)} />
    },
    {
        templateLabel: 'Associated keys action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(associatedKeysDeploy)} />
    },{
        templateLabel: 'Cspr market action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(csprMarketDeploy)} />
    },{
        templateLabel: 'CEP-18 action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(cep18Deploy)} />
    },{
        templateLabel: 'Nft action feed item:',
        renderComponent: (args) =>  <ActivityFeedItem {...args} deploy={MapDeploy(nftDeploy)} />
    },
];
